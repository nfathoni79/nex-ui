...
<template>
  <div class="bg-white">
    ...
    <TransitionRoot as="template" :show="mobileFiltersOpen">
      <Dialog as="div" @close="mobileFiltersOpen = false"
        ...
        <div class="fixed inset-0 z-40 flex">
          <TransitionChild as="template"
            ...
            <DialogPanel class="relative ml-auto flex h-full w-full max-w-xs flex-col
              overflow-y-auto bg-white py-4 pb-12 shadow-xl">
              <div class="flex items-center justify-between px-4">
                <h2 class="text-lg font-medium text-gray-900">Filters</h2>
                <button type="button" @click="mobileFiltersOpen = false"
                  class="-mr-2 flex h-10 w-10 items-center justify-center
                  rounded-md bg-white p-2 text-gray-400">
              ...
              <form class="mt-4 border-t border-gray-200">
                ...
                <Disclosure as="div" v-for="section in filters" :key="section.id" v-slot="{ open }"
    ...
    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex items-baseline justify-between
        border-b border-gray-200 pt-24 pb-6">
        ...
        <div class="flex items-center">
          <Menu as="div" class="relative inline-block text-left">
            <div>
              <MenuButton class="group inline-flex justify-center
            ...
            <transition enter-active-class="transition ease-out duration-100"
              ...
              <MenuItems class="absolute right-0 z-10 mt-2 w-40 origin-top-right
      ...
      <section aria-labelledby="products-heading" class="pt-6 pb-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
          ...
          <form class="hidden lg:block">
            <h3 class="sr-only">Categories</h3>
            <ul role="list" class="space-y-4 border-b border-gray-200 pb-6
          ...
          <div class="lg:col-span-3">
            ...
            <div class="h-96 lg:h-full rounded-lg border-4 border-dashed border-gray-200" />
            <!-- /End replace -->
          </div>
        </div>
      </section>
