...
-->
<template>
  <div class="mx-auto py-6 sm:px-6 lg:px-8 bg-gray-100">
    <!-- Profile -->
    <div>
              ...
              <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                ...
                <div>
                  ...
                  <div class="mt-1 flex items-center">
                    ...
                    <button type="button"
                      class="ml-5 rounded-md border border-gray-300
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          <form action="#" method="POST">
            <div class="overflow-hidden shadow sm:rounded-md">
                ...
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="first-name" id="first-name" autocomplete="given-name"
                      class="mt-1 block w-full
                      rounded-md border-gray-300 focus:border-blue-500 shadow-sm
                      focus:ring-blue-500 sm:text-sm" />
                  </div>
              ...
              <div class="bg-gray-50 px-4 sm:px-6 py-3 text-right">
                <button type="submit"
                  class="inline-flex justify-center
                  rounded-md border border-transparent shadow-sm
                  bg-blue-600 hover:bg-blue-700
