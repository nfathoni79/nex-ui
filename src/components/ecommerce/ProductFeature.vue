<template>
  <div class="bg-white">
    <div class="mx-auto max-w-2xl lg:max-w-7xl
      ...
      gap-x-8 gap-y-16 px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
      <div>
        ...
        <p class="mt-4 text-gray-500">
          ...
          The powder coated steel divider separates active cards from new ones,
          or can be used to archive important task lists.
        </p>

        <dl class="mt-16 grid grid-cols-1 sm:grid-cols-2
          gap-x-6 lg:gap-x-8 gap-y-10 sm:gap-y-16">
